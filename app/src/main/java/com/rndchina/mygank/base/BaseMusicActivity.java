...
import com.rndchina.mygank.music.MusicStateListener;
import com.rndchina.mygank.music.QuickControlsFragment;
...
import static com.rndchina.mygank.music.service.MusicPlayer.mService;
...
public abstract class BaseMusicActivity extends AppCompatActivity implements ServiceConnection{
    ...
    private final static class PlaybackStatus extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            BaseMusicActivity baseActivity = mReference.get();
